        ...
        <section className="mt-14">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="ml-auto rounded-full border border-[#3a1f14] px-5 py-2 text-[13px] text-[#7a6558] transition hover:border-[#e8451f] hover:text-[#ff9c6b]"
            >
              Delete idea
            </button>
          </div>
                  ...
                  {group.map((r) => (
                    <ResultCard
                      ...
                      action={
                        <button
                          type="button"
                          onClick={() => onRemoveResult(open.id, resultKey(r))}
